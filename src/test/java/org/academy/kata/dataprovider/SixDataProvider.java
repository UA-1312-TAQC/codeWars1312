...
public class SixDataProvider extends BaseDataProvider {
    ...
    public static Iterator<Object[]> dpFPositive() {
        final List<Object[]> inputs = new ArrayList<>();
        inputs.add(new Object[]{2.6e-08, 1.29999999155e-08});
        inputs.add(new Object[]{1.4e-09, 6.999999997549999e-10});
        inputs.add(new Object[]{5.0e-06, 2.499996875007812e-06});
        inputs.add(new Object[]{2.4e-07, 1.1999999280000085e-07});
        return  combineData(inputs, SIX);
    }

    @DataProvider(name="data-F-Negative")
    public static Iterator<Object[]> dpFNegative() {
        final List<Object[]> inputs = new ArrayList<>();
        inputs.add(new Object[]{2.6, 1.29999999155e-08});
        inputs.add(new Object[]{1.49, 6.999999997549999e-10});
        inputs.add(new Object[]{4.0e-06, 2.499996875007812e-06});
        inputs.add(new Object[]{2.44, 1.1999999280000085e-07});
        return  combineData(inputs, SIX);
    }
}
